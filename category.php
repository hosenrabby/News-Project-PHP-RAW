        ...
        <div class="row">
            <div class="col-md-8">
                ...
                <div class="post-container">
                    <?php 
                        $query = $dbcon->query("SELECT category_name FROM category WHERE category_id = '$cat_id'");
                            $cat_name = $query->fetch_assoc();
                     ?>
                  <h2 class="page-heading"><?=ucfirst($cat_name['category_name'])?></h2>
                    <?php 
                          include"db-con.php";
                    ...
                    <div class="post-container">
                        ...
                        $query = $dbcon->query("SELECT post FROM category WHERE category_id = '$cat_id'");
                            if (mysqli_num_rows($query) > 0) {
